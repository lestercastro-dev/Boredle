document.addEventListener('DOMContentLoaded', () => {
    ...
    "ABIDE", "ABORT", "ACORN", "ACTOR", "ADMIT", "ADOPT", "AGREE",
    "ALERT", "ALLOT", "ALLOW", "ALONE", "AMONG", "ANGER", "ARGUE",
    "ARISE", "ARRAY", "ARROW", "ASIDE", "AUDIO", "AVOID", "BASIC", 
    "BATCH", "BEGAN", "BEGIN", "BEING", "BIRTH", "BLEND", "BLINK", 
    "BLOCK", "BLOOD", "BLOWN", "BOARD", "BOATS", "BOUND", "BRAIN", 
    "BRAND", "BRING", "BROAD", "BROKE", "BROWN", "BUILD", "BURNT", 
    "BURST", "BUYER", "CABLE", "CACHE", "CAMPY", "CANDY", "CANOE", 
    "CARVE", "CAUSE", "CHAIN", "CHANT", "CHARM", "CHASE", "CHECK", 
    "CLEAN", "CLEAR", "CLIMB", "CLOSE", "COAST", "COUNT", "COURT", 
    "COVER", "CRACK", "CRASH", "CRATE", "CRISP", "CROWD", "CROWN", 
    "CURVE", "DAILY", "DAIRY", "DEALT", "DELAY", "DEPTH", "DEVIL", 
    "DIGIT", "DIRTY", "DOING", "DONUT", "DOUBT", "DOZEN", "DRAFT", 
    "DRAIN", "DRAWN", "DREAM", "DRIED", "DRINK", "DRIVE", "DROVE",
    "EAGER", "EARLY", "ELECT", "ELITE", "EMPTY", "ENJOY", "ENTER",
    "ENTRY", "ERROR", "EVENT", "EVERY", "EXACT", "EXTRA", "FAINT", 
    "FAITH", "FALSE", "FANCY", "FAULT", "FAVOR", "FEAST", "FENCE", 
    "FEVER", "FINAL", "FIRST", "FIXED", "FLAME", "FLASH", "FLOAT", 
    "FLOOD", "FLOOR", "FOCUS", "FORCE", "FORGE", "FORMS", "FOUND", 
    "FRAME", "FRESH", "FRIED", "FRONT", "FROST", "FROZE", "GIANT", 
    "GIVEN", "GLIDE", "GLORY", "GLOVE", "GOING", "GRACE", "GRADE", 
    "GRAIN", "GRAND", "GRANT", "GRASS", "GRAVE", "GREAT", "GRILL", 
    "GROUP", "GUARD", "GUESS", "GUEST", "GUIDE", "HABIT", "HAPPY", 
    "HARDY", "HEARD", "HEAVY", "HONEY", "HONOR", "HORSE", "HOTEL", 
    "HOUSE", "HUMAN", "HUMID", "HURRY", "IDEAL", "IMAGE", "IMPLY", 
    "INNER", "INPUT", "ISSUE", "IVORY", "JEANS", "JELLY", "JUICE", 
    "JUMPY", "KETCH", "KNOCK", "KNOWN", "LABEL", "LADEN", "LARGE", 
    "LAUGH", "LAYER", "LEARN", "LEASE", "LEGAL", "LEVEL", "LIGHT", 
    "LIKEN", "LIMIT", "LINEN", "LOCAL", "LOGIC", "LOOSE", "LOVER", 
    "LOWER", "MAJOR", "MAKER", "MAPLE", "MARCH", "MATCH", "MAYBE", 
    "MEDAL", "METAL", "MODEL", "MODES", "MONEY", "MONTH", "MOTTO", 
    "MOUTH", "MOVIE", "MUSIC", "NERVE", "NEVER", "NEWER", "NIGHT", 
    "NOBLE", "NOISE", "NORTH", "NOTED", "NOVEL", "OASIS", "OCCUR", 
    "OCEAN", "OFFER", "OFTEN", "OLDER", "ONION", "ORDER", "OTHER", 
    "OUTER", "PANEL", "PANIC", "PAPER", "PARTY", "PEACE", "PEARL", 
    "PEDAL", "PIECE", "PILOT", "PIXEL", "PLACE", "PLAIN", "PLANE", 
    "PLANT", "PLATE", "POINT", "POUND", "POWER", "PRICE", "PRIME", 
    "PRINT", "PRIZE", "PROOF", "PROUD", "PROVE", "PUPPY", "QUIET", 
    "QUILT", "QUITE", "RANGE", "RANKS", "RAPID", "READY", "REACT", 
    "REACH", "REBEL", "REFER", "RELAX", "REPLY", "RESET", "RIGHT", 
    "RIVAL", "ROAST", "ROBIN", "ROUGH", "ROUND", "ROYAL", "RURAL",
    "SAFER", "SAINT", "SCALE", "SCENE", "SCOPE", "SCORE", "SCOUT",
    "SEVEN", "SHADE", "SHAKE", "SHARE", "SHARP", "SHEEP", "SHEET",
    "SHELL", "SHIFT", "SHINE", "SHIRT", "SHOCK", "SHOOT", "SHORT",
    "SHOUT", "SHRUG", "SIDER", "SIGMA", "SILKY", "SINCE", "SKILL",
    "SKIRT", "SLEEP", "SLICE", "SLIDE", "SMALL", "SMILE", "SMOKE",
    "SNAKE", "SOLID", "SOLVE", "SORRY", "SOUND", "SOUTH", "SPACE",
    "SPARE", "SPEAK", "SPELL", "SPEND", "SPICE", "SPIKE", "SPINE",
    "SPORT", "STAGE", "STAND", "STARE", "START", "STEEL", "STEPS",
    "STICK", "STILL", "STOCK", "STONE", "STORE", "STORM", "STORY",
    "STOVE", "STRAP", "STRIP", "STUDY", "STYLE", "SUGAR", "SUPER", 
    "SWEAR", "SWEET", "TABLE", "TALKS", "TASTE", "TEACH", "TEAMS", 
    "TEARS", "TEMPO", "THANK", "THEME", "THERE", "THICK", "THIEF", 
    "THING", "THINK", "THIRD", "THREE", "THROW", "TIGHT", "TIMES", 
    "TITLE", "TODAY", "TOUCH", "TOUGH", "TOWER", "TRACK", "TRADE", 
    "TRAIN", "TREAT", "TREND", "TRIAL", "TRUCK", "TRUST", "TRUTH",
    "UNCLE", "UNDER", "UNION", "UNITE", "UNTIL", "UPPER", "URBAN",
    "VALUE", "VEGAN", "VENOM", "VIDEO", "VIRAL", "VISIT", "VIVID",
    "VOICE", "WATCH", "WATER", "WHOLE", "WIDER", "WOMAN", "WOMEN", 
    "WORLD", "WORRY", "WORTH", "WRITE", "YACHT", "YEARN", "YIELD", 
    "YOUNG", "ZEBRA"
    ];
